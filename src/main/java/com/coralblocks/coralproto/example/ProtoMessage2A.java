...
public class ProtoMessage2A extends AbstractProto {
	...
	public static void main(String[] args) throws IOException {
		...
		String filePath = "src/main/java/com/coralblocks/coralproto/example/" + ProtoMessage2A.class.getSimpleName() + ".java";
    ...
    public final IntField extraField = new IntField(this, true);
