...
public class ProtoMessage1A extends AbstractProto {
	...
	public static void main(String[] args) throws IOException {
		...
		String filePath = "src/main/java/com/coralblocks/coralproto/example/" + ProtoMessage1A.class.getSimpleName() + ".java";
    ...
    public final IntField extraField = new IntField(this);
